...
import nl.rug.oop.rts.protocol.objects.model.units.dwarves.AxeThrower;
import nl.rug.oop.rts.protocol.objects.model.units.dwarves.Guardian;
import nl.rug.oop.rts.protocol.objects.model.units.dwarves.Phalanx;
import nl.rug.oop.rts.protocol.objects.model.units.elves.LorienWarrior;
import nl.rug.oop.rts.protocol.objects.model.units.elves.MirkwoodArcher;
import nl.rug.oop.rts.protocol.objects.model.units.elves.RivendellLancer;
import nl.rug.oop.rts.protocol.objects.model.units.isengard.UrukCrossbowman;
import nl.rug.oop.rts.protocol.objects.model.units.isengard.UrukHai;
import nl.rug.oop.rts.protocol.objects.model.units.isengard.WargRider;
import nl.rug.oop.rts.protocol.objects.model.units.men.GondorSoldier;
import nl.rug.oop.rts.protocol.objects.model.units.men.IthilienRanger;
import nl.rug.oop.rts.protocol.objects.model.units.men.TowerGuard;
import nl.rug.oop.rts.protocol.objects.model.units.mordor.HaradrimArcher;
import nl.rug.oop.rts.protocol.objects.model.units.mordor.OrcPikeman;
import nl.rug.oop.rts.protocol.objects.model.units.mordor.OrcWarrior;
import nl.rug.oop.rts.protocol.objects.model.units.rohan.RohanArcher;
